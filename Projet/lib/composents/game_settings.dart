...
class GamesSettings extends StatelessWidget {
  GamesSettings(
      {Key? key,
      required this.functionToBeUsed,
      required this.functionToResumeTimer,
      required this.functionToStopTimer})
      : super(key: key);
